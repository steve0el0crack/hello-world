...
;;Creating CHANNELS and making use of more specialized features of core.async library
...
(go
  (letfn [(surprise [universe cst]
            (update universe :healthcapacity (fn [x cst] (* x cst))))]
    (surprise world 3)))
